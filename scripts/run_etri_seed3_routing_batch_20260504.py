...
CAT_W = 0.80
OUTPUT_CONFIGS = [
    # 현재 0.59553 축(q6040/s2080)을 중심으로 하루 3회 제출 후보를 안정적으로 탐색한다.
    {"name": "q6545_s2080_alpha098", "q": (0.65, 0.35), "s": (0.20, 0.80), "alpha": 0.98},
    {"name": "q7040_s2080_alpha098", "q": (0.70, 0.30), "s": (0.20, 0.80), "alpha": 0.98},
    {"name": "q6040_s2080_alpha0985", "q": (0.60, 0.40), "s": (0.20, 0.80), "alpha": 0.985},
    {"name": "q6040_s2080_alpha099", "q": (0.60, 0.40), "s": (0.20, 0.80), "alpha": 0.99},
    {"name": "q6040_s3070_alpha098", "q": (0.60, 0.40), "s": (0.30, 0.70), "alpha": 0.98},
]
...
def main():
    ...
    for cfg in OUTPUT_CONFIGS:
        ...
        print("\n" + "=" * 90)
        print(f"[OUTPUT] {cfg['name']} | alpha={cfg['alpha']}")
        print("=" * 90)
        ...
        for t in TARGETS:
            ...
            p = shrink_proba(p, alpha=cfg["alpha"])
        ...
        out_path = BASE_DIR / "submissions" / f"sub_seed3_routing_{cfg['name']}.csv"
