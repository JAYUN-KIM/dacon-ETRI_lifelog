...
LGB_W = 0.20
CAT_W = 0.80
OUT_PATH = BASE_DIR / "submissions" / "sub_probe_alpha098_blend2080_logitblend.csv"
...
def main():
    ...
    for t in TARGETS:
        z = LGB_W * to_logit(final_pred_lgb[t].values) + CAT_W * to_logit(final_pred_cat[t].values)
        p = from_logit(z)
