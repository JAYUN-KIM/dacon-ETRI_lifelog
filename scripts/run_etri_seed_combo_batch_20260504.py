...
CAT_W = 0.80
SEED_COMBOS = [
    {"name": "seeds42_2024_777", "seeds": [42, 2024, 777]},
    {"name": "seeds77_2024_1004", "seeds": [77, 2024, 1004]},
    {"name": "seeds42_77_777", "seeds": [42, 77, 777]},
    {"name": "seeds7_42_2024", "seeds": [7, 42, 2024]},
]
...
def main():
    ...
    print("=" * 90)
    print("SEED COMBO BATCH | q6040 / s2080 / alpha098")
    print("=" * 90)
    ...
    for combo in SEED_COMBOS:
        ...
        print("\n" + "=" * 90)
        print(f"[COMBO] {combo['name']} | seeds={seeds}")
        print("=" * 90)
        ...
        out_path = BASE_DIR / "submissions" / f"sub_seed3_routing_q6040_s2080_alpha098_{combo['name']}.csv"
