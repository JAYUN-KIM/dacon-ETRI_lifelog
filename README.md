...
- 최신 기록: **2026-04-29** / structure experiment + target-wise alpha split 결과 0.598044066으로 소폭 악화, 공통 alpha 0.98 + blend 0.2:0.8이 더 안정적임을 확인
<!-- AUTO:SUMMARY:END -->
...
| 2026-04-24 | stable baseline 유지, shrink alpha 0.90과 fixed blend 비율 조정 실험 진행, 0.3:0.7에서 0.5991758604로 최고점 갱신 | 0.5991758604 | exp | 3953db7 |
...
- 다음 이어서 할 일:
  - `structure experiment + target-wise alpha split 결과 0.598044066으로 소폭 악화, 공통 alpha 0.98 + blend 0.2:0.8이 더 안정적임을 확인` 기준으로 다음 실험 이어가기
