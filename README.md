...
- 최신 기록: **2026-05-01** / seed ensemble 구조 실험 정리, 3-seed ensemble은 0.5957800203으로 큰 폭 개선되었으나 5-seed ensemble은 0.5963145855로 소폭 악화되어 현재는 3-seed + 타겟별 블렌드 라우팅 구성이 최적임을 확인
<!-- AUTO:SUMMARY:END -->
