...
- 최신 기록: **2026-04-29** / 4월 29일 구조 실험 3종 수행: target-wise alpha split(0.598044066), small recent/change features(0.606743338), logit-space blending(0.5979976852) 모두 기존 최고를 넘지 못했고, stable baseline + alpha 0.98 + blend 0.2:0.8 + weighted probability average가 최적 구성으로 재확인됨
<!-- AUTO:SUMMARY:END -->
