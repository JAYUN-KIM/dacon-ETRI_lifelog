...
- 최신 기록: **2026-05-02** / 새로운 피처 축 실험으로 mUsageStats 앱 사용 패턴 feature를 풍부하게 추가했으나 0.59726345로 악화, 앱 사용 정보는 과도하게 넣을 경우 노이즈와 과적합 가능성이 있음을 확인
<!-- AUTO:SUMMARY:END -->
...
- 다음 이어서 할 일:
  - `새로운 피처 축 실험으로 mUsageStats 앱 사용 패턴 feature를 풍부하게 추가했으나 0.59726345로 악화, 앱 사용 정보는 과도하게 넣을 경우 노이즈와 과적합 가능성이 있음을 확인` 기준으로 다음 실험 이어가기
