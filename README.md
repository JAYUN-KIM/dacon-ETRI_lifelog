...
- 최신 기록: **2026-05-02** / 새로운 피처 축 실험, mUsageStats를 최소 count/ratio feature만 남겨 3-seed ensemble과 타겟별 블렌드 라우팅 구조에 추가하여 rich usage feature의 과적합 가능성 확인
<!-- AUTO:SUMMARY:END -->
...
- 다음 이어서 할 일:
  - `새로운 피처 축 실험, mUsageStats를 최소 count/ratio feature만 남겨 3-seed ensemble과 타겟별 블렌드 라우팅 구조에 추가하여 rich usage feature의 과적합 가능성 확인` 기준으로 다음 실험 이어가기
