...
- 최신 기록: **2026-04-27** / alpha 0.98 + blend 0.15:0.85는 0.5979019616으로 소폭 악화, 현재 최고 구성은 stable baseline + alpha 0.98 + blend 0.2:0.8 with 0.5978689256로 확정하고 실험을 마감, 이후 논문 작성 단계로 전환
<!-- AUTO:SUMMARY:END -->
...
| 2026-04-24 | stable baseline에 shrink alpha 0.90과 fixed blend 0.4:0.6 적용, 0.6000012518로 크게 개선되며 11등 진입 | 0.6000012518 | exp | 7be2f7d |
| 2026-04-24 | stable baseline + fixed alpha 0.90 | 0.6059629619 | exp | 5e8c0e7 |
| 2026-04-23 | stable baseline에서 shrink alpha 미세조정 실험 진행, alpha 0.78은 악화, 0.80은 개선, 0.85에서 0.6064374291로 최고점 갱신 | 0.6064374291 | exp | 92c4f2e |
...
- 다음 이어서 할 일:
  - `alpha 0.98 + blend 0.15:0.85는 0.5979019616으로 소폭 악화, 현재 최고 구성은 stable baseline + alpha 0.98 + blend 0.2:0.8 with 0.5978689256로 확정하고 실험을 마감, 이후 논문 작성 단계로 전환` 기준으로 다음 실험 이어가기
